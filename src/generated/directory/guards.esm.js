...
export var isSinginOutputWithRefreshToken = function(obj) {
  if (!obj || !obj.__typename) throw new Error('__typename is missing in "isSinginOutputWithRefreshToken"')
...
export var iscustomer_user = function(obj) {
  if (!obj || !obj.__typename) throw new Error('__typename is missing in "iscustomer_user"')
...
export var iscustomers = function(obj) {
  if (!obj || !obj.__typename) throw new Error('__typename is missing in "iscustomers"')
...
var user_basic_data_possibleTypes = ['user_basic_data']
export var isuser_basic_data = function(obj) {
  if (!obj || !obj.__typename) throw new Error('__typename is missing in "isuser_basic_data"')
...
var user_phone_possibleTypes = ['user_phone']
export var isuser_phone = function(obj) {
  if (!obj || !obj.__typename) throw new Error('__typename is missing in "isuser_phone"')
  return user_phone_possibleTypes.includes(obj.__typename)
}



var user_phone_aggregate_possibleTypes = ['user_phone_aggregate']
export var isuser_phone_aggregate = function(obj) {
  if (!obj || !obj.__typename) throw new Error('__typename is missing in "isuser_phone_aggregate"')
  return user_phone_aggregate_possibleTypes.includes(obj.__typename)
}



var user_phone_aggregate_fields_possibleTypes = ['user_phone_aggregate_fields']
export var isuser_phone_aggregate_fields = function(obj) {
  if (!obj || !obj.__typename) throw new Error('__typename is missing in "isuser_phone_aggregate_fields"')
  return user_phone_aggregate_fields_possibleTypes.includes(obj.__typename)
}



var user_phone_max_fields_possibleTypes = ['user_phone_max_fields']
export var isuser_phone_max_fields = function(obj) {
  if (!obj || !obj.__typename) throw new Error('__typename is missing in "isuser_phone_max_fields"')
  return user_phone_max_fields_possibleTypes.includes(obj.__typename)
}



var user_phone_min_fields_possibleTypes = ['user_phone_min_fields']
export var isuser_phone_min_fields = function(obj) {
  if (!obj || !obj.__typename) throw new Error('__typename is missing in "isuser_phone_min_fields"')
  return user_phone_min_fields_possibleTypes.includes(obj.__typename)
}



var user_phone_mutation_response_possibleTypes = ['user_phone_mutation_response']
export var isuser_phone_mutation_response = function(obj) {
  if (!obj || !obj.__typename) throw new Error('__typename is missing in "isuser_phone_mutation_response"')
